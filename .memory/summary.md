...
Stage errors wrapped in `StageError` (stage number, name, underlying error, hint) for consistent formatting.
...
- `workflow/` — orchestration, state management, cleanup, summary output, preflight checks, StageError type
